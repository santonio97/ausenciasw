...
<hr/>
<h3>Aplicación PWA + FullStack MEN (MongoDB + Express + Nodejs). Desplegada en <a href="https://herokuapp.com/">Heroku</a>, aunque eso lo haré al terminar de desarrollarla en local, para luego subir los archivos a Heroku</h3>
